...
st.title(':blue[Analyzing allergens in cosmetics comes with several limitations and challenges, some of which are:]')
...
Some manufacturers may not disclose the complete list of ingredients on the product label, making it difficult to identify potential allergens.
    ...
    """)
st.subheader('2. Varying individual reactions:')
st.write(
    """
...
""")
st.subheader('7. Regulatory differences: ')

st.write(
    """
Different countries have different regulations regarding allergens and ingredient labeling, leading to inconsistencies in the information available to consumers.
""")
